function [grad_k0, grad_tau0, grad_k1, grad_theta1, grad_phi1, grad_theta2, grad_phi2, energy_val] = ...
    self_getGeometryParamsFFGradientsForBihelix_common_tau(k0, tau0, k1, theta1, phi1, theta2, phi2, arcLength, C_GT, C0, j_idx, err_type)
    ...
    if strcmp(err_type, "avg_err")
        ...
        for i = 1:j_idx
            ...
            % -- derivative values --
            Df = self_diff_bihelix_func_wrt_curve_geometry_common_tau_FF(k0, tau0, k1, s, sj, theta1, phi1, theta2, phi2);    
