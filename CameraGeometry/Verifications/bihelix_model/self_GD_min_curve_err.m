function [opt_res, collect_gd_errors, collect_learning_rate, minErr_err_percentage] = self_GD_min_curve_err(gdParams, initParams, initFrenetFrame, trajectory_pts, j_idx, err_type)
    % -- do gradient descent --
    ...
    for gd_iter = 1:gd_iterations
        ...
        [bihelixCurveFromModel, arcLength] = self_generateBihelixFromModel(k0, tau0, k1, tau1, prop_T, prop_N, prop_B, trajectory_pts, j_idx);
        
        % -- get gradients of curvature and torsion --
        if strcmp(err_type, "avg_err")
            [gradient_k0, gradient_tau0, gradient_k1, gradient_tau1, gradient_theta, energy_val] = ...
            self_getGeometryParamsGradientForBihelix(k0, tau0, k1, tau1, candidate_theta, arcLength, init_N, init_B, prop_T, prop_N, prop_B, trajectory_pts, bihelixCurveFromModel, j_idx);
        elseif strcmp(err_type, "end_pt_err")
            [gradient_k0, gradient_tau0, gradient_k1, gradient_tau1, gradient_theta, energy_val] = ...
            self_getGeometryParamsGradientForBihelix_EndPtErr(k0, tau0, k1, tau1, candidate_theta, arcLength, init_N, init_B, prop_T, prop_N, prop_B, trajectory_pts, bihelixCurveFromModel, j_idx);
        end
